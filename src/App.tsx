...
import type { Profile, ProfileInput, SpeedSample, TrafficEvent } from "./types";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      <header className="fixed inset-x-0 top-0 z-20 border-b border-zinc-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-6 py-3">
          <div className="min-w-0">
            <p className="text-sm font-medium text-zinc-600">Shadowsocks client</p>
          </div>
          <button
            type="button"
      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-4 px-6 pb-6 pt-20">
        <div
